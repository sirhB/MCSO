...
/**
 * Daylight Authority template content.
 * Adapted from the editorial homepage — same facts, services, and imagery
 * with copy tightened for the redesigned layout.
 */
export const authorityHomeData: Data<MCSOProps> = {
  root: { props: { title: "MCSO Security Group — Authority" } },
  content: [
    {
      type: "Header",
      props: {
